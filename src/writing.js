...
containerEl.addEventListener(
  ...
  debounce((e) => {
    if (
      e.target.classList.contains("writing-title") ||
      e.target.classList.contains("writing-text")
    ) {
...
saveBtn.addEventListener("click", (e) => {
  ...
  writing.setId(writingId).setTitle(titleEl.value).setContent(textAreaEl.value);
